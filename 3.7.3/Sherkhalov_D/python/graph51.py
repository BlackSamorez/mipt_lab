...
plt.xlabel(r'$x_2,\, s^{-\frac{1}{2}}$, ', fontsize=14)
plt.ylabel(r'$y_2,\, cm^{-1}$', fontsize=14)
plt.title(r'$y_2(x_2)$', fontsize=14)
plt.grid(True)
...
plt.plot(x, yfit, color="firebrick", label=r'МНК $y_2(x_2)$')
